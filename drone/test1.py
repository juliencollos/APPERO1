# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 21:37:37 2020
...
def test_get_weigth():
    ...
    if ap.get_weight(list_1_node[0], list_1_node[1], list_1) == 1:
        print("TRUE")
    else:
        print("FALSE")
    print("Le poids attendu entre", list_1_node[1], "et", list_1_node[2],": 3")
    if ap.get_weight(list_1_node[1], list_1_node[2], list_1) == 3:
        print("TRUE")
    else:
        print("FALSE")
    print("Le poids attendu entre", list_1_node[1], "et", list_1_node[2],": 5")
    if ap.get_weight(list_1_node[2], list_1_node[0], list_1) == 5:
        print("TRUE")
    else:
        print("FALSE")
...
def test_get_neighbours():
    ...
    if ap.get_neighbours(list_1, list_1_node[0]) == [1,2]:
        print("TRUE")
    else:
        print("FALSE")
    print("Le/Les voisin(s) attendu(s) de", list_1_node[1], "sont: 0-2")
    if ap.get_neighbours(list_1, list_1_node[1]) == [0,2]:
        print("TRUE")
    else:
        print("FALSE")
    print("Le/Les voisin(s) attendu(s) de", list_1_node[2], "sont: 0-1")
    if ap.get_neighbours(list_1, list_1_node[2]) == [0,1]:
        print("TRUE")
    else:
        print("FALSE")
...
def test_get_neighbours_oriented():
    ...
    if ap.get_neighbours_oriented(list_1, list_1_node[0]) == [1]:
        print("TRUE")
    else:
        print("FALSE")
    print("Le/Les voisin(s) attendu(s) de", list_1_node[1], "sont: 2")
    if ap.get_neighbours_oriented(list_1, list_1_node[1]) == [2]:
        print("TRUE")
    else:
        print("FALSE")
    print("Le/Les voisin(s) attendu(s) de", list_1_node[2], "sont: 0")
    if ap.get_neighbours_oriented(list_1, list_1_node[2]) == [0]:
        print("TRUE")
    else:
        print("FALSE")
...
def test_is_eulerian():
    ...
    if ap.is_eulerian(len(list_1_node), list_1) == True:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_1_node), list_1))
    else:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_1_node), list_1))
    print()
    print("Le graph est:", list_2, "et le resultat attendu est: True")
    if ap.is_eulerian(len(list_2_node), list_2) == True:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_2_node), list_2))
    else:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_2_node), list_2))
    print()
    print("Le graph est:", list_3, "et le resultat attendu est: False")
    if ap.is_eulerian(len(list_3_node), list_3) == True:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_3_node), list_3))
    else:
        print("Le graph est Eulerien:", ap.is_eulerian(len(list_3_node), list_3))
